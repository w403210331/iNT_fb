...
class FindnsaveLocationSpider(scrapy.Spider):
    ...
    def parse(self, response):
        #with open( '/tmp/findnsave_location.html', 'w' ) as f:
        ...
        for st in states:
            ...
            for loc in locs:
                ...
                l_name = fx_extract( loc, './a/text()' )
                csvw.writerow( [ st_short, sts.get( st_short, '' ), l_name, url ] )
                print st_short, l_name, url
